...
<div id="donate" class="module">
  <h2>Donate</h2>
  <p>Donate a quid (or more) a month to help us pay hosting bills.  Cheers muchly.</p>
  <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
  <input type="hidden" name="cmd" value="_s-xclick">
  <input type="hidden" name="hosted_button_id" value="M4Y96NCVP9JG2">
  <input type="hidden" name="on0" value="Subscription Options" class="test">
  <select name="os0">
    <option value="1">&pound;1 - monthly</option>
    <option value="2">&pound;2 - monthly</option>
    <option value="3">&pound;3 - monthly</option>
    <option value="4">&pound;4 - monthly</option>
    <option value="5">&pound;5 - monthly</option>
  </select> 
  
  <input type="hidden" name="currency_code" value="GBP">
  <input type="image" src="https://www.paypalobjects.com/en_US/GB/i/btn/btn_subscribeCC_LG.gif" border="0" name="submit" alt="PayPal – The safer, easier way to pay online." class="pp-but">
  <img alt="" border="0" src="https://www.paypalobjects.com/en_GB/i/scr/pixel.gif" width="1" height="1">
  </form>
</div>

<div id="side-ad" class="module partner">
